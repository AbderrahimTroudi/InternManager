...
export class AddInternshipComponent {
  ...
  messageErr=''
    ...
    constructor(private dataService: ServicesService,private route:Router,private http: HttpClient,private Route:ActivatedRoute) {
      ...
      this.dataService.getappbyid("internship/get_supervisor_internship/",this.id).subscribe(data=>{
        this.dataArray=data
        this.AllData=data
  console.log(this.AllData)
  console.log("tyeazae : ",this.dataArray)
  ...
  console.log("test data : ",data)
      let x = this.dataService.addInternshipBySupervisor(data,"internship/addInternshipBySupervisor/",this.id).subscribe(response=>{
        this.dataService.getAllStudents("internship/get_supervisor_internship").subscribe(data=>{
          this.dataArray=data
          this.AllData=data
        })
      },(err:HttpErrorResponse)=>{
